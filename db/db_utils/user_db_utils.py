"""Утилиты работы с БД для записей пользователя."""
...
def joined_to_dict(user_model: UserModel, user_dict: dict, joined_models: list) -> dict:
    """Добавление словарей связанных моделей БД."""
